...
Not illustrated, but part of the solution, the `Logger` provides structured console output with push/pull context tracking so that log lines are always attributed to the right module and operation.
